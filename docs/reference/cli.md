...
kisti-db-manager json run --config path/to/openalex_config.json --mode parse-parquet-safe --flatten-backend rust-arrow --rust-raw-jsonl-parse --rust-raw-jsonl-file-parse --rust-columnar-accumulator
