...
- For OpenAlex-scale operations, continue with [OpenAlex Runbook](../operator-guides/openalex-runbook.md).
- For mode details, see [JSON Modes](../reference/modes.md).
- For architecture context, see [JSON Pipeline Architecture](../architecture/json-pipeline.md).
